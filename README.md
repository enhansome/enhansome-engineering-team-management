...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 109,586 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,060 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,858 | 🐛 25 | 📅 2026-07-29 - Niche job boards by domains, technology, roles and area.
...
* [Reverse interview](https://github.com/viraptor/reverse-interview) ⭐ 28,593 | 🐛 23 | 📅 2025-02-19 - Questions to ask the company during your interview. Be prepared to answer them as a manager.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,846 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [hacker-laws](https://github.com/dwmkerr/hacker-laws) ⭐ 27,282 | 🐛 154 | 🌐 HTML | 📅 2026-09-06 - Laws, Theories, Principles and Patterns that developers will find useful.
...
* [Awesome Concepts](https://github.com/lukasz-madon/awesome-concepts) ⭐ 630 | 🐛 8 | 📅 2024-03-04 - Laws, principles, mental models and cognitive biases.
...
* [The Efficiency-Destroying Magic of Tidying Up](https://flocrivello.com/the-efficiency-destroying-magic-of-tidying-up/) - “Efficiency tends to look messy, and good looks tend to be inefficient.” A reminder that sometimes we should just accept [the messiness of the world](https://github.com/kdeldycke/awesome-falsehood) ⭐ 27,673 | 🐛 5 | 📅 2026-08-14.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 48,485 | 🐛 90 | 📅 2026-08-16 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [How to exit vim, the Product Manager way](https://github.com/hakluke/how-to-exit-vim/blob/master/README.md#the-product-manager-way) ⭐ 7,191 | 🐛 105 | 📅 2026-08-05 - A satire with a grain of truth, especially the comparison between the basic vs experienced level.

* [Open Product Management](https://github.com/tron1991/open-product-management) ⭐ 4,462 | 🐛 17 | 📅 2024-07-01 - Resources, interviews, case studies, sample products & projects, communities, open source tools, free & paid services on product management, for technical people to learn the field.

* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,351 | 🐛 92 | 🌐 CSS | 📅 2026-09-07 - A reference. All the missing pieces are found below.
...
The [header image](https://github.com/kdeldycke/awesome-engineering-team-management/blob/main/assets/awesome-management-header.png) ⭐ 2,597 | 🐛 4 | 📅 2026-08-14 is based on a modified [photo taken in November 2017](https://unsplash.com/photos/6dDHofabCQ8) by [Werner Du plessis](https://unsplash.com/@werner01).
