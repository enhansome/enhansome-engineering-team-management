...
* [Paper we love: Software Engineering Organizations](https://github.com/papers-we-love/papers-we-love/tree/master/software_engineering_orgs) ⭐ 109,941 | 🐛 4 | 🌐 Shell | 📅 2026-09-17 - “The practice of software engineering, and its history is, itself, a complex study in humanity, coordination, and communication.”
...
* [Hiring Without Whiteboards](https://github.com/poteto/hiring-without-whiteboards) ⭐ 52,181 | 🐛 11 | 🌐 JavaScript | 📅 2026-08-24 - List of companies without the kind of CS trivia questions that are associated with bad interview practices.

* [Awesome Job Boards](https://github.com/tramcar/awesome-job-boards) ⭐ 1,867 | 🐛 33 | 📅 2026-07-29 - Niche job boards by domains, technology, roles and area.
...
* [FizzBuzz Enterprise Edition](https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition) ⭐ 23,864 | 🐛 546 | 🌐 Java | 📅 2024-07-15 - A satire of over-engineering for the sake of enterprise-grade software.
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) ⭐ 48,923 | 🐛 96 | 📅 2026-09-21 - Resources on working remotely, including job boards, coworking spaces, and a list of companies embracing the culture.
...
* [Awesome Product Management](https://github.com/dend/awesome-product-management) ⭐ 2,373 | 🐛 108 | 🌐 CSS | 📅 2026-09-07 - A reference. All the missing pieces are found below.
